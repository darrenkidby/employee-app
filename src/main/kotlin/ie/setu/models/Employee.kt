...
class Employee (var firstName: String, var surname: String, var gender: Char, var employeeId: Int,
    ...
    override fun toString(): String {
        return "Employee(firstName='$firstName', surname='$surname', gender=$gender, employeeID=$employeeId, grossSalary=$grossSalary, paye=$paye, prsi=$prsi, annualBonus=$annualBonus, cycle=$cycle)"
    }
}